...
while True: #Game Loop
    ...
    #Instrument tab
    pygame.draw.rect(Surface, Black, (0, 0, 0, windowHeight/2), 3)
    Text("Instruments", 76, windowHeight/1.68, 28, Black)
    pygame.draw.line(Surface, Black, (0, windowHeight/1.62), (360, windowHeight/1.62), 4)    
